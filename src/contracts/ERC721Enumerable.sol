...
contract ERC721Enumerable is IERC721Enumerable, ERC721 {
    ...
    function _mint(address idIssuedToAddress, uint tokenId, string memory _identityType, string memory _organizationType, address issuedBy) internal override(ERC721) {
        super._mint(idIssuedToAddress, tokenId, _identityType, _organizationType, issuedBy);
        // 2 things! A. add tokens to the owner
        // B. all tokens to our totalsuppy - to allTokens
        _addTokensToAllTokenEnumeration(tokenId); 
        _addTokensToOwnerEnumeration(idIssuedToAddress, tokenId);
    }
